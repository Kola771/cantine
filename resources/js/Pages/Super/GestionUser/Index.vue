...
<template>
    ...
    <div class="fixed top-0 bottom-0 right-0 lg:w-[85%] lg:h-screen z-50">
        ...
        <div class="mx-auto lg:w-[80%] lg:mt-[80px] shadow-2xl rounded">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <transition>
                                <div v-if="variableBool"
                                    class="z-50 absolute lg:top-10 lg:left-[408px] bg-white rounded lg:w-[125px] shadow-2xl">
                                    <span
                            ...
                            <transition>
                                <div v-if="variableBool1"
                                    class="z-50 absolute lg:top-10 lg:left-[538px] bg-white rounded lg:w-[125px] shadow-2xl lg:max-h-[184px] overflow-y-auto">
                                    <span
                                        class="block w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 hover:bg-gray-200 focus:outline-none focus:bg-gray-300 transition duration-150 ease-in-out cursor-pointer flex items-center justify-between border-gray-100 border-b-[1px]">
                                        Page 1
                                    </span>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr class="border-gray-400 border-b-[1px]">
                                <td class="py-2 text-center"><input type="checkbox" class="checkbox"></td>
            ...
            <div class="rounded-b lg:py-2 lg:px-2 flex justify-between items-center bg-gray-200">
                ...
                <span class="bg-blue-700 text-sm text-white lg:py-1.5 lg:px-8 rounded">100</span>
            </div>
        </div>
    </div>
    ...
    <div id="formHidden"
      ...
      sm:leading-5 resize-none focus:outline-none focus:border-gray-200" placeholder="Adresse électronique*"
            ...
            <div class="lg:basis-[100%]">
                <select class="w-full border-2 rounded-md px-4 py-2 leading-5 transition duration-150 ease-in-out sm:text-sm
    ...
    <div id="formHidden1"
        ...
        <form @submit.prevent="createForm1" class="flex p-6 flex-col gap-4">
            <div v-if="message" :class="'my-2 md:my-1 text-sm text-center font-bold ' + color">{{ message }}</div>
            <div class="lg:basis-[100%]">
